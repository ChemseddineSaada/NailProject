 ...
 */
final class Version20190911190622 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD annoncement LONGTEXT NOT NULL, CHANGE event_date event_date DATETIME DEFAULT NULL, CHANGE event_place event_place VARCHAR(255) DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP annoncement, CHANGE event_date event_date DATETIME DEFAULT \'NULL\', CHANGE event_place event_place VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE image image VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
