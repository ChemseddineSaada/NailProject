 ...
 */
final class Version20190904184903 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD event TINYINT(1) NOT NULL, ADD event_date DATETIME DEFAULT NULL, CHANGE tags tags LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE annexe annexe LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP event, DROP event_date, CHANGE tags tags LONGTEXT DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\', CHANGE annexe annexe LONGTEXT DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\'');
        $this->addSql('ALTER TABLE cart CHANGE user_id user_id INT DEFAULT NULL');
