 ...
 */
final class Version20190830211644 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD quantity INT NOT NULL, CHANGE user_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart DROP quantity, CHANGE user_id user_id INT DEFAULT NULL');
