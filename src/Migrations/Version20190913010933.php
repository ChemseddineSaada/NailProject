 ...
 */
final class Version20190913010933 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event_subs DROP email_confirm');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event_subs ADD email_confirm VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci');
