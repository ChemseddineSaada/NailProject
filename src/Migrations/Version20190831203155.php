 ...
 */
final class Version20190831203155 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD promo_rate INT DEFAULT NULL, CHANGE images images LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE price price NUMERIC(5, 2) DEFAULT NULL, CHANGE stock stock INT DEFAULT NULL, CHANGE note note INT DEFAULT NULL, CHANGE promo promo VARCHAR(100) DEFAULT NULL, CHANGE ref ref VARCHAR(100) DEFAULT NULL');
